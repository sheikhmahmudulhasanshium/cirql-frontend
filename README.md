# <img src='![/logo.png](https://github.com/sheikhmahmudulhasanshium/cirql-frontend/blob/main/public/logo.png?raw=true)' alt='Cirql Logo' width='40' style='vertical-align: middle;' /> CiRQL: "Stay In the Loop."
